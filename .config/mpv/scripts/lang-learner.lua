...
mp.add_key_binding(o["key_open_url1"], "ll-open-in-url1", function()
	do_open_in_url("url1")
end)
mp.add_key_binding(o["key_open_url2"], "ll-open-in-url2", function()
	do_open_in_url("url2")
end)
mp.add_key_binding(o["key_open_url3"], "ll-open-in-url3", function()
	do_open_in_url("url3")
end)
